...
/***/ function(module, exports, __webpack_require__) {
	...
	Game.prototype.draw = function (ctx) {
	  ...
	  if (this.lives > 0) {
	    ...
	    ctx.fillText("Score: " + this.score, 800, 70);
	    ctx.fillText("Lives: ", 800, 40);
	    for (var i = 1; i < this.lives+1; i++) {
	      ctx.drawImage(rocketShip, (840 + (i*38)), 8, 40, 40);
	    }
	  } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	Ship.prototype.draw = function (ctx) {
	  ctx.drawImage(rocketShip, this.pos[0] - 20, this.pos[1] - 25, 80, 80);
	};
